...
foreach(FILE IN LISTS SCRIPT_API_BINARY_FILES)
    file(STRINGS "${FILE}" LINES REGEX "^void SQ${APIUC}.*_Register\\(Squirrel &engine(, \\[\\[maybe_unused\\]\\] ${APIUC}SubAPIs sub_apis)?\\)$")
    if(LINES)
        ...
        foreach(LINE IN LISTS LINES)
            ...
            string(REGEX REPLACE "(Squirrel &|\\[\\[maybe_unused\\]\\] ${APIUC}SubAPIs )" "" LINE "${LINE}")
...
set(SQUIRREL_REGISTER "	SQ${APIUC}List_Register(engine, sub_apis);\n${SQUIRREL_REGISTER};")
