 ...
 */
static void DrawTile_Town(TileInfo *ti, bool, Corner)
{
 ...
 */
static Foundation GetFoundation_Town(TileIndex index, Tile tile, Slope tileh)
{
 ...
 * @param index TileIndex of the house to animate.
 * @param tile Tile of the house to animate.
 */
static void AnimateTile_Town(TileIndex index, Tile tile)
{
...
static TrackStatus GetTileTrackStatus_Town(TileIndex, Tile, TransportType, uint, DiagDirection)
{
	/* not used */
	return 0;
}

static bool ChangeTileOwner_Town(TileIndex, Tile &, Owner, Owner)
{
	/* not used */
	return false;
}
...
static CommandCost TerraformTile_Town(TileIndex index, Tile tile, DoCommandFlags, int z_new, Slope tileh_new)
{
	if (AutoslopeEnabled()) {
		HouseID house = GetHouseType(tile);
