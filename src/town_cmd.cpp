...
static RoadBits GetTownRoadGridElement(Town *t, TileIndex tile, DiagDirection dir)
{
	...
	switch (GetTileSlope(tile).base()) {
		...
		case Slope{BaseSlope::W}.base(): rb_template = {RoadBit::NW, RoadBit::SW}; break;
		case Slope{BaseSlope::S}.base(): rb_template = {RoadBit::SW, RoadBit::SE}; break;
		case Slope{BaseSlope::E}.base(): rb_template = {RoadBit::SE, RoadBit::NE}; break;
		case Slope{BaseSlope::N}.base(): rb_template = {RoadBit::NE, RoadBit::NW}; break;
