 ...
 * @pre IsTileType(t, MP_TUNNELBRIDGE) || IsTileType(t, MP_METRO_ENTRANCE)
 * @return the above mentioned direction
 */
inline DiagDirection GetTunnelBridgeDirection(Tile t)
{
	assert(IsTileType(t, MP_TUNNELBRIDGE) || IsTileType(t, MP_METRO_ENTRANCE));
 ...
 * @pre (IsTileType(t, MP_TUNNELBRIDGE) || IsTileType(t, MP_METRO_ENTRANCE)) && GetTunnelBridgeTransportType(t) == TRANSPORT_RAIL
 * @param t the tile
