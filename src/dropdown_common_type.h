...
public:
	...
	{
		this->hide_on_ctrl = hidden_states.Test(DropDownHiddable::State::CtrlPressed);
		this->hide_on_shift = hidden_states.Test(DropDownHiddable::State::ShiftPressed);
		this->hide_on_default = hidden_states.Test(DropDownHiddable::State::Default);
	}
