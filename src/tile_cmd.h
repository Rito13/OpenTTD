 ...
 */
typedef std::tuple<CommandCost, bool> ClearTileProc(TileIndex index, Tile &tile, DoCommandFlags flags);
 ...
 */
typedef void AddAcceptedCargoProc(TileIndex index, Tile tile, CargoArray &acceptance, CargoTypes &always_accepted);
 ...
 */
typedef void AddProducedCargoProc(TileIndex index, Tile tile, CargoArray &produced);
...
typedef VehicleEnterTileStates VehicleEnterTileProc(Vehicle *v, TileIndex index, Tile tile, int x, int y);
typedef Foundation GetFoundationProc(TileIndex index, Tile tile, Slope tileh);
 ...
 */
typedef CommandCost TerraformTileProc(TileIndex index, Tile tile, DoCommandFlags flags, int z_new, Slope tileh_new);
