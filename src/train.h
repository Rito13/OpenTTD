...
protected: // These functions should not be called outside acceleration code.
	...
	inline uint16_t GetPower() const
	{
		...
		if (!this->IsArticulatedPart() && HasPowerOnRail(this->railtypes, GetTileRailType(this->tile, TrackdirToTrack(this->GetVehicleTrackdir())))) {
	...
	inline uint16_t GetPoweredPartPower() const
	{
		...
		if (this->flags.Test(VehicleRailFlag::PoweredWagon) && HasPowerOnRail(this->railtypes, GetTileRailType(this->tile, TrackdirToTrack(this->GetVehicleTrackdir())))) {
	...
	{
		return GetRailTypeInfo(GetTileRailType(this->tile, TrackdirToTrack(this->GetVehicleTrackdir())))->max_speed;
	}
