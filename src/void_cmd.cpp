...
static void DrawTile_Void(TileInfo *ti, bool, Corner)
{
	DrawGroundSprite(SPR_FLAT_BARE_LAND + SlopeToSpriteOffset(ti->tileh), PALETTE_ALL_BLACK);
}


static Foundation GetFoundation_Void(TileIndex, Tile, Slope)
{
...
static TrackStatus GetTileTrackStatus_Void(TileIndex, Tile, TransportType, uint, DiagDirection)
{
	return 0;
}

static CommandCost TerraformTile_Void(TileIndex, Tile, DoCommandFlags, int, Slope)
{
