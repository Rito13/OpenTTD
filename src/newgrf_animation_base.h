...
struct TileAnimationFrameAnimationHelper {
	 ...
	 */
	static uint8_t Get(Tobj *, TileIndex, const Tile &tile) { return GetAnimationFrame(tile); }
	 ...
	 */
	static bool Set(Tobj *, TileIndex, const Tile &tile, uint8_t frame)
	{
...
struct AnimationBase {
	 ...
	 */
	static void AnimateTile(const Tspec *spec, Tobj *obj, TileIndex index, const Tile &tile, bool random_animation, Textra extra_data = {})
	{
		assert(spec != nullptr);
	 ...
	 */
	static void ChangeAnimationFrame(CallbackID cb, const Tspec *spec, Tobj *obj, TileIndex index, const Tile &tile, uint32_t random_bits, uint32_t trigger, Textra extra_data = {})
	{
