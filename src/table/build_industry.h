 ...
 */
#define MT(ca1, c1, ca2, c2, ca3, c3, sl, a1, a2, a3) IndustryTileSpec{ \
	{INVALID_CARGO, INVALID_CARGO, INVALID_CARGO, INVALID_CARGO, INVALID_CARGO, INVALID_CARGO, INVALID_CARGO, INVALID_CARGO, INVALID_CARGO, INVALID_CARGO, INVALID_CARGO, INVALID_CARGO, INVALID_CARGO, INVALID_CARGO, INVALID_CARGO, INVALID_CARGO}, \
 ...
 */
static consteval IndustryTileSpec CreateSimpleIndustryTileSpec(int8_t cargo_acceptance1, std::variant<CargoLabel, MixedCargoType> cargo1, int8_t cargo_acceptance2, std::variant<CargoLabel, MixedCargoType> cargo2, bool is_construction)
{
...
static constexpr IndustryTileSpec _origin_industry_tile_specs[NEW_INDUSTRYTILEOFFSET] = {
	...
	/* Power Station */
	CreateSimpleIndustryTileSpec(0, CT_INVALID, 0, CT_INVALID, false),
	CreateSimpleIndustryTileSpec(1, CT_PASSENGERS, 8, CT_COAL, false),
	CreateSimpleIndustryTileSpec(0, CT_INVALID, 0, CT_INVALID, false),
	CreateSimpleIndustryTileSpec(0, CT_INVALID, 0, CT_INVALID, false),
	...
	CreateSimpleIndustryTileSpec(1, CT_PASSENGERS, 0, CT_INVALID, false),
	CreateSimpleIndustryTileSpec(1, CT_PASSENGERS, 0, CT_INVALID, false),
	CreateSimpleIndustryTileSpec(1, CT_PASSENGERS, 8, CT_WOOD, false),
	CreateSimpleIndustryTileSpec(0, CT_INVALID, 0, CT_INVALID, false),
	CreateSimpleIndustryTileSpec(0, CT_INVALID, 0, CT_INVALID, false),
	...
	CreateSimpleIndustryTileSpec(0, CT_INVALID, 0, CT_INVALID, false),
	CreateSimpleIndustryTileSpec(0, CT_INVALID, 0, CT_INVALID, false),
	CreateSimpleIndustryTileSpec(0, CT_INVALID, 8, CT_OIL, false),
	CreateSimpleIndustryTileSpec(0, CT_INVALID, 0, CT_INVALID, false),
	CreateSimpleIndustryTileSpec(0, CT_INVALID, 0, CT_INVALID, false),
	CreateSimpleIndustryTileSpec(1, CT_PASSENGERS, 0, CT_INVALID, false),

	/* Oil Rig */
	CreateSimpleIndustryTileSpec(0, CT_INVALID, 8, CT_PASSENGERS, false),
	CreateSimpleIndustryTileSpec(0, CT_INVALID, 8, CT_MAIL, false),
	CreateSimpleIndustryTileSpec(0, CT_INVALID, 0, CT_INVALID, false),
	CreateSimpleIndustryTileSpec(0, CT_INVALID, 0, CT_INVALID, false),
	CreateSimpleIndustryTileSpec(0, CT_INVALID, 0, CT_INVALID, false),
	...
	/* Paper mill */
	CreateSimpleIndustryTileSpec(0, CT_INVALID, 8, CT_WOOD, false),
	CreateSimpleIndustryTileSpec(0, CT_INVALID, 8, CT_WOOD, false),
	CreateSimpleIndustryTileSpec(0, CT_INVALID, 8, CT_WOOD, false),
	CreateSimpleIndustryTileSpec(0, CT_INVALID, 8, CT_WOOD, false),
	CreateSimpleIndustryTileSpec(0, CT_INVALID, 8, CT_WOOD, false),
	...
	/* Toy shop */
	CreateSimpleIndustryTileSpec(0, CT_INVALID, 8, CT_TOYS, false),
	CreateSimpleIndustryTileSpec(0, CT_INVALID, 8, CT_TOYS, false),
	CreateSimpleIndustryTileSpec(0, CT_INVALID, 8, CT_TOYS, false),
	CreateSimpleIndustryTileSpec(0, CT_INVALID, 8, CT_TOYS, false),

	/* Toy factory */
	CreateSimpleIndustryTileSpec(8, CT_BATTERIES, 8, CT_PLASTIC, false),
	CreateSimpleIndustryTileSpec(8, CT_BATTERIES, 8, CT_PLASTIC, false),
	CreateSimpleIndustryTileSpec(8, CT_BATTERIES, 8, CT_PLASTIC, false),
	CreateSimpleIndustryTileSpec(8, CT_BATTERIES, 8, CT_PLASTIC, false),
	CreateSimpleIndustryTileSpec(8, CT_BATTERIES, 8, CT_PLASTIC, false),
	...
	/* Fizzy drink factory */
	CreateSimpleIndustryTileSpec(8, CT_BUBBLES, 8, CT_COLA, false),
	CreateSimpleIndustryTileSpec(8, CT_BUBBLES, 8, CT_COLA, false),
	CreateSimpleIndustryTileSpec(8, CT_BUBBLES, 8, CT_COLA, false),
	CreateSimpleIndustryTileSpec(8, CT_BUBBLES, 8, CT_COLA, false),
