...
extern const TypedIndexContainer<std::array<TrackdirBits, 31>, Slope> _uphill_trackdirs = {
	...
	TRACKDIR_BIT_X_SW | TRACKDIR_BIT_Y_NW, ///<  1 BaseSlope::W -> inclined for diagonal track
	TRACKDIR_BIT_X_SW | TRACKDIR_BIT_Y_SE, ///<  2 BaseSlope::S -> inclined for diagonal track
	TRACKDIR_BIT_X_SW                    , ///<  3 SLOPE_SW
	TRACKDIR_BIT_X_NE | TRACKDIR_BIT_Y_SE, ///<  4 BaseSlope::E -> inclined for diagonal track
	TRACKDIR_BIT_NONE                    , ///<  5 SLOPE_EW
	TRACKDIR_BIT_Y_SE                    , ///<  6 SLOPE_SE
	TRACKDIR_BIT_NONE                    , ///<  7 SLOPE_WSE -> leveled
	TRACKDIR_BIT_X_NE | TRACKDIR_BIT_Y_NW, ///<  8 BaseSlope::N -> inclined for diagonal track
