...
enum RailFenceType {
	...
	RAIL_FENCE_NW, ///< Grass with a fence at the NW edge
	RAIL_FENCE_SE, ///< Grass with a fence at the SE edge
	RAIL_FENCE_SENW, ///< Grass with a fence at the NW and SE edges
	RAIL_FENCE_NE, ///< Grass with a fence at the NE edge
	RAIL_FENCE_SW, ///< Grass with a fence at the SW edge
	RAIL_FENCE_NESW, ///< Grass with a fence at the NE and SW edges
	RAIL_FENCE_VERT1, ///< Grass with a fence at the eastern side
	RAIL_FENCE_VERT2, ///< Grass with a fence at the western side
	RAIL_FENCE_HORIZ1, ///< Grass with a fence at the southern side
	RAIL_FENCE_HORIZ2, ///< Grass with a fence at the northern side
};
