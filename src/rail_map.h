...
using RailTileIterator = AssociatedTileIterator<TileType::Railway>;
 ...
 */
[[debug_inline]] static inline RailTileType GetRailTileType(const Tile &t)
{
 ...
 */
[[debug_inline]] static inline bool IsPlainRail(const Tile &t)
{
 ...
 * @return true if and only if the tile is normal rail (with or without signals)
 */
[[debug_inline]] static inline bool IsPlainRailTile(const Tile &t)
{
 ...
 */
[[debug_inline]] static inline bool IsRailDepot(const Tile &t)
{
 ...
 * @return true if and only if the tile is a rail depot
 */
[[debug_inline]] static inline bool IsRailDepotTile(const Tile &t)
{
