...
void AddSortableSpriteToDraw(SpriteID image, PaletteID pal, int x, int y, int z, const SpriteBounds &bounds, bool transparent = false, const SubSprite *sub = nullptr, bool rotate = false);
...
inline void AddSortableSpriteToDraw(SpriteID image, PaletteID pal, const Coord3D<int32_t> &world, const SpriteBounds &bounds, bool transparent = false, const SubSprite *sub = nullptr, bool rotate = false)
{
	AddSortableSpriteToDraw(image, pal, world.x, world.y, world.z, bounds, transparent, sub, rotate);
}
