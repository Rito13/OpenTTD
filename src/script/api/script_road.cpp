...
static int32_t LookupWithBuildOnSlopes(::Slope slope, const Array<RoadPartOrientation> &existing, RoadPartOrientation start, RoadPartOrientation end)
{
	...
	static constexpr TypedIndexContainer<std::array<::Slope, 15>, ::Slope> base_slopes = {
		::SLOPE_FLAT, {::BaseSlope::W}, {::BaseSlope::W}, ::SLOPE_SW,
		{::BaseSlope::W}, ::SLOPE_EW, ::SLOPE_SW, ::SLOPE_WSE,
		{::BaseSlope::W}, ::SLOPE_SW, ::SLOPE_EW, ::SLOPE_WSE,
	...
	if (slope.base() >= base_slopes.size()) {
	...
	switch (slope.base()) {
		case ::Slope{::BaseSlope::W}.base():
			/* A slope similar to a BaseSlope::W. */
