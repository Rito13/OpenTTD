...
public:
	...
	void Draw(Blitter::BlitterParams *bp, BlitterMode mode, ZoomLevel zoom, bool rotate) override;
...
protected:
	template <bool Tpal_to_rgb> void Draw(Blitter::BlitterParams *bp, BlitterMode mode, ZoomLevel zoom, bool rotate);
